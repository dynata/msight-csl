*********************************************
Contributing to the MarketSight API Client
*********************************************

.. note::

  As a general rule of thumb, the **MarketSight API Client** applies
...
**MarketSight Core** is meant to be a "beautiful" and "usable" library.
...
**MarketSight Core** we rely on several tools:
...
#. Fork the `Git repository <https://github.com/Dynata/msight-csl>`_.
...
#. Install dev dependencies:
  ...
  .. code-block:: bash
    ...
    msight-csl/ $ pip install -r requirements.dev.txt
...
Check for open `issues <https://github.com/Dynata/msight-csl/issues>`_
...
.. seealso::
  ...
  For more information about the **MarketSight Core** testing approach please
  see: :doc:`Testing the MarketSight Core library <testing>`
...
.. code-block:: bash
  ...
  msight-csl/docs/_build/html/index.html
...
Thanks to everyone who helps make the **MarketSight API Client** library useful:
